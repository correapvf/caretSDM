...
#' 
#' This is a wrapper function for \code{\link[caret]{confusionMatrix}}, but it accepts directly a caret model and a data.frame with test data.
...
#' 
#' When \code{control} is provided, arguments "method", "number", "repeats" and "p" are obtained from the \code{trainControl} 
...
#' @param method,number,repeats,p Check \code{\link[caret]{trainControl}} for details. Only used if \code{control = NULL}.
